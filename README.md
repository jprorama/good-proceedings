# GOOD Conference Proceedings

This repository receives submissions for the Global Open OnDemand Conference Proceedings.

The submission, acceptance, and publication process is conducted in a spirit of openness; submissions are publicly visible, published articles are open access, and the technologies behind the proceedings are built on open source tools.

All authors, commenters, and editors are expected to show respect and courtesy to each other, following the [NumFOCUS Code of Conduct](https://numfocus.org/code-of-conduct).
...
- Once everyone is happy, editors will switch the label to `accepted` and your submission is complete!